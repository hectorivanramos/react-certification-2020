...
const CardGroup = require('./CardGroup.component').default


describe('CardGroup.component', () => {
    const item = [{
        kind: "youtube#searchResult",
        etag: "Jiak50jVoJ9_Uscl6Dwcb7VySrI",
        id: {
            kind: "youtube#video",
            videoId: "nmXMgqjQzls"
        },
    ...
    it('render CardGroup', () => {
        render(<CardGroup payload={item} />);
        expect(screen.getByText(item[0].snippet.title)).toBeTruthy();
    });
